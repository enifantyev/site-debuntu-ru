...
2. Пакеты, добавляемые через `sudo pip install --user`, устанавливаются в зависимости от версии Python, например в `/root/.local/lib/python3.8`, и доступны только для аккаунта `root`.
