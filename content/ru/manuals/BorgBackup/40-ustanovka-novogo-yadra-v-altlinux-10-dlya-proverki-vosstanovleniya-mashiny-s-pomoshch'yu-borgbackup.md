---
title: "40. Установка нового ядра в AltLinux 10 для проверки восстановления машины с помощью BorgBackup"
date: 2022-03-18
weight: 40
description: >
  Описание способа установки нового Linux-ядра в AltLinux-машину для последующей попытке возврата машины к ранее созданному снимку с помощью связки LVM и BorgBackup.
tags:
  - BorgBackup
  - Backup SoftWare
  - LVM
