...
```
# cat ip.hosts
10.15.195.1 is01-airf01p.example.org
10.15.195.3 is01-app01p.example.org
10.15.195.4 is01-app02p.example.org
10.15.112.52 is02-app208p.example.org
10.15.112.53 is02-app209p.example.org
```
...
while read line; do
  echo ""
  echo $line     # "10.15.195.1 is01-airf01p.example.org"
  arr1=($line)   # конвертируем переменную в массив из двух элементов
  ip1=${arr1[0]} # "10.15.195.1"
